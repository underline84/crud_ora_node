...
app.get('/alunos', function (req, res) {
    ...
    oracledb.getConnection(connAttrs, function (err, connection) {
        ...
        connection.execute("SELECT * FROM alunos", {}, {
            ...
            connection.release(
                function (err) {
                    if (err) {
                        ...
                        console.log("GET /alunos : Connection released");
                    }
                });
        });
    });
...
app.get('/aluno/:id_aluno', function (req, res) {
    "use strict";
    ...
    oracledb.getConnection(connAttrs, function (err, connection) {
        ...
        connection.execute("SELECT * FROM alunos WHERE id_aluno = :id_aluno", [req.params.ID_ALUNO], {
            outFormat: oracledb.OBJECT // Return the result as Object
        }, function (err, result) {
            if (err || result.rows.length < 1) {
                ...
                res.status(status).send(JSON.stringify({
                    status: status,
                    message: err ? "Error getting the user profile" : "aluno doesn't exist",
            ...
            connection.release(
                function (err) {
                    if (err) {
                        ...
                        console.log("GET /aluno/" + req.params.ID_ALUNO + " : Connection released");
                    }
                });
        });
    });
